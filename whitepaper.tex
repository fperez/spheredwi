...
Wavelet techniques are a natural mathematical tool for analysis of signals
...
``needlets'', a wavelet-like construction that respects the topology of the sphere.
